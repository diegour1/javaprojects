...
public class PanelProducto extends JPanel implements ActionListener
{
    ...
    /**
     * Comando para vender el celular.
     */
    ...
    public PanelProducto( InterfazSubasta pVentanaPrincipal, int pNumTelefono )
    {
        ...
        btnVender.setIcon( new ImageIcon( "./data/sold.png" ) );
        ...
        pnlBoton.setLayout( new GridLayout(1, 2) );

        pnlBoton.add( btnOferta );
        pnlBoton.add( btnVender );
    ...
    public void actualizar( Celular pTelefono )
    {
        ...
        if(pTelefono.estaVendido())
        {
        	imgTelefono.setIcon( new ImageIcon( "./data/celular" + numTelefono + "_sold.png" ) );
        }else {
        	imgTelefono.setIcon( new ImageIcon( "./data/celular" + numTelefono + ".png" ) );
        }
        updateUI();
